...
<template>
    <article class="card h-100 shadow-sm d-flex flex-column tarjeta-concierto">
...
.imagen-concierto {
    ...
    /* 200px */
    object-fit: cover;
    /* Asegura que la imagen cubra sin deformarse */
}
...
/* Ajuste para que los botones no se peguen en móvil */
@media (max-width: 575.98px) {
    .d-grid>.btn+.btn {
        margin-top: 0.5rem;
        /* Añade espacio entre botones en vista de grilla (móvil) */
    }
}
</style>